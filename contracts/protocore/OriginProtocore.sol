...
contract OriginProtocore is MasterCopyNonUpgradable, GenesisOriginProtocore, Protocore {
    ...
    /**
     * @notice proposeLink() function proposes a valid link to be
     *         voted later by active validators.
     *
     * @param _parentVoteMessageHash Vote message hash of the parent link.
     * @param _targetBlockHash Block hash for the target checkpoint.
     * @param _targetBlockNumber Block number for the target checkpoint.
     */
    function proposeLink(
        ...
        external
    {
        // For the origin protocore the source transition hash is zero.
